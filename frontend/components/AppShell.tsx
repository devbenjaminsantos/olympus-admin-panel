    ...
    <div className="app-shell">
      <header className="global-nav">
        <div className="global-nav-inner">
          <Link className="nav-brand" href="/dashboard" aria-label="RunBase dashboard">
          ...
          <div className="nav-actions">
            <div className="nav-user">
              <span className="nav-avatar" aria-hidden>{user.name.slice(0, 1).toUpperCase()}</span>
              <span className="nav-user-copy">
                <strong>{user.name}</strong>
                <span>{user.role}</span>
              </span>
            </div>
            <button className="icon-button icon-button-dark" onClick={handleLogout} title="Logout" type="button">
